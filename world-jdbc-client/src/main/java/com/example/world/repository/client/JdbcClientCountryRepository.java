...
public class JdbcClientCountryRepository implements CountryRepository {
	...
	public Optional<Country> findOne(String code) {
		Country country = jdbcClient.sql(SELECT_COUNTRY_BY_CODE).query(Country.class).single();
	...
	public Collection<Country> findAll() {
		List<Country> countries = jdbcClient.sql(SELECT_ALL_COUNTRIES).query(Country.class).list();
